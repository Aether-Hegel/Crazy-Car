...
//#endif
    ...
    extern uint32_t __VECTOR_RAM[];  //��ȡ��RAM�е��ж���������ʼ��ַ
    extern uint32_t __VECTOR_TABLE[];//��ȡ��FLASH�е��ж���������ʼ��ַ
    extern uint32_t __RAM_VECTOR_TABLE_SIZE[];

    uint32_t vector_size = ((uint32_t)__RAM_VECTOR_TABLE_SIZE)/4;//��ȡ�ж���������С
	...
	uint32_t * VECTOR_RAM ;  //��ȡ��RAM�е��ж���������ʼ��ַ
    uint32_t * VECTOR_TABLE;//��ȡ��FLASH�е��ж���������ʼ��ַ
    uint32_t RAM_VECTOR_TABLE_SIZE = 0x400;

	VECTOR_RAM = (uint32_t *)0x80000000;
	VECTOR_TABLE = (uint32_t *)0x70002000;
	
    uint32_t vector_size = ((uint32_t)RAM_VECTOR_TABLE_SIZE)/4;//��ȡ�ж���������С
